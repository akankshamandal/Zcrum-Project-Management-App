...
export default function IssueCreationDrawer({
  ...
  useEffect(() => {
  console.log("Users from useFetch:", users);
}, [users]);
...
useEffect(() => {
  if (isOpen && orgId) {
    console.log("Fetching users for:", orgId);
    fetchUsers(orgId);
  }
  ...
  const onSubmit = async (data: IssueFormData) => {
    ...
    const result = await createIssueFn(projectId, {
      ...data,
      status,
      sprintId,
    });
            ...
            <Controller
              ...
              render={({ field }) => (
                ...
                >
                  ...
                  <SelectContent>
                      {(users as UserType[] | undefined)?.map((user) => {
